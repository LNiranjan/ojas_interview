...
class TvShowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tv_show" do
    assert_difference('TvShow.count') do
      post tv_shows_url, params: { tv_show: { channel: @tv_show.channel, show: @tv_show.show, timing: @tv_show.timing } }
    end
  ...
  test "should update tv_show" do
    patch tv_show_url(@tv_show), params: { tv_show: { channel: @tv_show.channel, show: @tv_show.show, timing: @tv_show.timing } }
